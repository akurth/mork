...
public class ManualConflictResolver implements ConflictResolver {
    ...
    public ManualConflictResolver(IntBitSet terminalsA, int actionA, IntBitSet terminalsB, int actionB) {
